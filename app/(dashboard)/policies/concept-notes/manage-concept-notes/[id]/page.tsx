            ...
            <TabsContent value="overview" className="mt-6 space-y-6">
                ...
                <CardContent className="pt-5">
                  <dl className="grid gap-4 sm:grid-cols-2">
                    {[
                      ...
                      {
                        label: "Author",
                        value: `${note.createdBy.firstName} ${note.createdBy.lastName}`,
                      },
                      {
                        label: "Organization",
                        value:
                      ...
                      {
                        label: "Status",
                        value: note.status.replace("_", " ").toUpperCase(),
                      },
              ...
              <Card className="shadow-sm border-primary/10">
                ...
                <CardContent className="pt-5 flex flex-wrap gap-2">
                  {["Health Systems", "Digital Policy", "Education"].map(
                    (area) => (
                      <Badge
                        key={area}
                        variant="secondary"
              ...
              <Card className="shadow-sm border-primary/10">
                <CardHeader className="border-b bg-muted/30 pb-4">
                  <CardTitle className="text-base flex items-center gap-2">
                    <FileText className="h-4 w-4 text-primary" /> Supporting
                    Files
                  </CardTitle>
                </CardHeader>
                <CardContent className="pt-5">
                  ...
                  <div className="my-8 shadow-2xl bg-white w-full max-w-[800px] min-h-[1100px] p-8 sm:p-16 space-y-8 text-slate-800">
                    ...
                    <div className="space-y-6 text-justify">
                      ...
                      <p className="leading-relaxed text-sm sm:text-base">
                        ...
                        for health policy refinement within the national
                        education and health systems. It outlines the strategic
                        objectives, implementation methodologies, and oversight
                        mechanisms required to achieve the stated outcomes
                        within the operational period of 2025-2027.
                      </p>
                    </div>
              ...
              <div className="grid gap-6">
                {note.reviews && note.reviews.length > 0 ? (
                  note.reviews.map((review) => (
                    <Card
                      key={review.id}
                      className="shadow-sm border-primary/10 overflow-hidden"
                    >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-muted-foreground">
                                ...
                                · {review.reviewer.institution || "PSR Council"}
                              </span>
                            </div>
                          </div>
                            ...
                            <Badge
                              className={cn(
                                ...
                                review.decision === "Accepted" ||
                                  ...
                                  : review.decision === "Partially Accepted" ||
                      ...
                      <div className="bg-muted/10 border-t py-2 px-4 flex justify-between items-center">
                        <span className="text-[10px] text-muted-foreground flex items-center gap-1">
                          <Calendar className="h-3 w-3" /> Reviewed on{" "}
