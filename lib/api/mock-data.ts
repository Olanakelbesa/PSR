...
export const mockPolicyDocuments: PolicyDocument[] = [
  ...
  },
  {
    ...
    description: 'Strategic roadmap for digital health transformation in Ethiopia',
    type: 'strategy',
    status: 'under_review',
    ...
    currentVersion: 1,
    attachments: [
      { id: 'att-5', name: 'DHS_Draft_v1.0.pdf', type: 'application/pdf', size: 4500000, url: '#', uploadedAt: '2024-03-10T00:00:00Z' }
    ],
    reviews: [],
    createdAt: '2024-03-05T00:00:00Z',
    updatedAt: '2024-03-10T00:00:00Z',
  },
  {
    ...
    description: 'National training standards document and implementation toolkit',
    type: 'standard',
  ...
  },
  {
    id: 'pol-006',
    title: 'National Health Insurance Implementation Guidelines',
    description: 'Actionable guidelines for the rollout of the national health insurance program',
    type: 'guideline',
    status: 'draft',
