...
export const conceptNoteSchema = z.object({
  ...
  policyType: z.enum(['policy', 'strategy', 'guideline', 'protocol', 'standard', 'directive']),
})
...
export const policyDocumentSchema = z.object({
  ...
  type: z.enum(['policy', 'strategy', 'guideline', 'protocol', 'standard', 'directive']),
...
export const callForProposalSchema = z.object({
  title: z
    .string()
    .min(1, 'Title is required')
    .min(10, 'Title must be at least 10 characters'),
...
export type ProposalMethodologyFormData = z.infer<typeof proposalMethodologySchema>
