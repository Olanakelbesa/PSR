...
import type { UserRole, PolicyStatus, PolicyType, ProposalStatus, CallStatus } from '@/lib/types'
...
export const POLICY_STATUSES: Record<PolicyStatus, { label: string; color: string }> = {
...
export const POLICY_TYPES: Record<PolicyType, { label: string; description: string }> = {
...
export const PROPOSAL_STATUSES: Record<ProposalStatus, { label: string; color: string }> = {
  draft: { label: 'Draft', color: 'bg-gray-100 text-gray-800' },
  submitted: { label: 'Submitted', color: 'bg-blue-100 text-blue-800' },
  under_review: { label: 'Under Review', color: 'bg-yellow-100 text-yellow-800' },
  revision_requested: { label: 'Revision Requested', color: 'bg-orange-100 text-orange-800' },
...
export const CALL_STATUSES: Record<CallStatus, { label: string; color: string }> = {
  draft: { label: 'Draft', color: 'bg-gray-100 text-gray-800' },
...
export const MAIN_NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: 'FlaskConical',
    children: [
      { title: 'Call for Proposals', href: '/research/calls', icon: 'Megaphone' },
      { title: 'My Proposals', href: '/research/proposals', icon: 'FileStack' },
      { title: 'Reviews', href: '/research/reviews', icon: 'ClipboardCheck', roles: ['roc_reviewer', 'psr_officer'] },
...
export const ALLOWED_FILE_TYPES = {
  ...
  all: ['.pdf', '.doc', '.docx', '.odt', '.rtf', '.xlsx', '.xls', '.csv', '.jpg', '.jpeg', '.png', '.gif'],
}
