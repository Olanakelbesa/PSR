...
export const userApi = {
  getUsers: async (...args: any[]) =>
    (await apiClient.get("/users", { params: Object.assign({}, ...args) }))
      .data,
...
export const conceptNoteApi = {
  getConceptNotes: async (...args: any[]) =>
    (
      await apiClient.get("/v1/concept-notes/", {
        params: Object.assign({}, ...args),
      })
    ).data,
  getConceptNote: async (id: string) =>
    (await apiClient.get(`/v1/concept-notes/${id}/`)).data,
  createConceptNote: async (data: any) =>
    (await apiClient.post("/v1/concept-notes/", data)).data,
  updateConceptNote: async (id: string, data: any) =>
    (await apiClient.patch(`/v1/concept-notes/${id}/`, data)).data,
  deleteConceptNote: async (id: string) =>
    (await apiClient.delete(`/v1/concept-notes/${id}/`)).data,
  submitConceptNote: async (id: string) =>
    (await apiClient.post(`/v1/concept-notes/${id}/submit/`)).data,
};
...
export const taxonomyApi = {
  getThematicAreas: async (...args: any[]) =>
    (
      await apiClient.get("/v1/thematicareas", {
        params: Object.assign({}, ...args),
      })
    ).data,
  getInstitutions: async (...args: any[]) =>
    (
      await apiClient.get("/v1/organizations/", {
        params: Object.assign({}, ...args),
      })
    ).data,
};
...
export const callsApi = {
  getCalls: async (...args: any[]) =>
    (await apiClient.get("/calls", { params: Object.assign({}, ...args) }))
      .data,
  ...
  updateCall: async (id: string, data: any) =>
    (await apiClient.patch(`/calls/${id}`, data)).data,
  deleteCall: async (id: string) =>
    (await apiClient.delete(`/calls/${id}`)).data,
};
...
export const monitoringApi = {
  ...
  getProgressReport: async (id: string) =>
    (await apiClient.get(`/projects/progress-reports/${id}`)).data,
  getProjects: async (...args: any[]) =>
    (await apiClient.get("/projects", { params: Object.assign({}, ...args) }))
      .data,
  getProjectById: async (id: string) =>
    (await apiClient.get(`/projects/${id}`)).data,
  submitProgressReport: async (id: string, data: any) =>
    (await apiClient.post(`/projects/progress-reports/${id}/submit`, data))
      .data,
  getTerminalReports: async (...args: any[]) =>
    (
      await apiClient.get("/projects/terminal-reports", {
        params: Object.assign({}, ...args),
      })
    ).data,
